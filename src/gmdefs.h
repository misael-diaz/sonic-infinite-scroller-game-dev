...
#define GAME_BLOCK_WIDTH 1000
#define GAME_BLOCK_HEIGHT 3000
#define GAME_SONIC_WIDTH 128
#define GAME_SONIC_HEIGHT 176
...
#define GAME_CAMERA_CATCHUP_YVEL 250
#define GAME_PLATFORM_XVEL 0
#define GAME_PLATFORM_YVEL 0
#define GAME_BLOCK_XVEL 0
#define GAME_BLOCK_YVEL 0
