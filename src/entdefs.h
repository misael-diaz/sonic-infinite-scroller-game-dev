...
#define EN_MAXNUMOF_ENT 10
#define EN_MAXNUMOF_PLATFORMS 3
#define EN_CAMERA_ID 0
#define EN_PLATFORM_BETA_ID 1
#define EN_PLATFORM_ZETA_ID 2
#define EN_PLATFORM_IOTA_ID 3
#define EN_ENEMY_MOTOBUG_ALPHA_ID 4
#define EN_ENEMY_MOTOBUG_GAMMA_ID 5
#define EN_ENEMY_MOTOBUG_DELTA_ID 6
#define EN_ENEMY_MOTOBUG_THETA_ID 7
#define EN_ENEMY_MOTOBUG_KAPPA_ID 8
#define EN_SONIC_ID 9
