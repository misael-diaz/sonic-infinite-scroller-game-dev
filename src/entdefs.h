...
#define EN_MAXNUMOF_ENT 9
#define EN_CAMERA_ID 0
#define EN_PLATFORM_BETA_ID 1
#define EN_PLATFORM_ZETA_ID 2
#define EN_ENEMY_MOTOBUG_ALPHA_ID 3
#define EN_ENEMY_MOTOBUG_GAMMA_ID 4
#define EN_ENEMY_MOTOBUG_DELTA_ID 5
#define EN_ENEMY_MOTOBUG_THETA_ID 6
#define EN_ENEMY_MOTOBUG_KAPPA_ID 7
#define EN_SONIC_ID 8
