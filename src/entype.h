...
enum enid {
	...
	EN_MAXNUMOF_PLATFORMS = (EN_PLATFORM_END_ID - EN_PLATFORM_START_ID),
	EN_MAXNUMOF_BLOCKS = (EN_BLOCK_END_ID - EN_BLOCK_START_ID),
	EN_MAXNUMOF_ENEMIES = (EN_ENEMY_END_ID - EN_ENEMY_START_ID)
};
